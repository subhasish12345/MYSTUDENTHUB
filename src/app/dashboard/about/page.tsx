...
import { GraduationCap, Code, Users, ShieldCheck } from "lucide-react";
        ...
        <div className="space-y-8 max-w-4xl mx-auto">
            ...
            <Card className="shadow-lg">
                ...
                <CardContent className="space-y-4 text-muted-foreground">
                    <p>
                        MyStudentHub is a modern, comprehensive web platform designed to streamline and enhance the academic and social lives of students, faculty, and administrators. Built with a powerful stack including Next.js, Firebase, and Tailwind CSS, it provides a centralized digital ecosystem for everything from attendance tracking to campus-wide event announcements.
                    </p>
                    <p>
                 ...
                 <Card>
                    ...
                    <CardContent className="space-y-2 text-muted-foreground">
                       <ul className="list-disc list-inside space-y-2">
                            ...
                            <li><strong>Data Security:</strong> Role-based access and secure data handling with Firebase.</li>
